...
##Pmod Header JA (XADC)
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { loop_0 }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p		   
...
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { loop_1 }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P             
...
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { FCLK_CLK0_0 }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
...
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports {  FCLK_CLK0_0  }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
